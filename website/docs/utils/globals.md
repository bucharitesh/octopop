...
- [FADE\_IN\_ANIMATION\_SETTINGS](variables/FADE_IN_ANIMATION_SETTINGS.md)
- [FRAMER\_MOTION\_LIST\_ITEM\_VARIANTS](variables/FRAMER_MOTION_LIST_ITEM_VARIANTS.md)
- [STAGGER\_CHILD\_VARIANTS](variables/STAGGER_CHILD_VARIANTS.md)
- [SWIPE\_REVEAL\_ANIMATION\_SETTINGS](variables/SWIPE_REVEAL_ANIMATION_SETTINGS.md)
...
- [paramsMetadata](variables/paramsMetadata.md)
- [constructURLFromUTMParams](functions/constructURLFromUTMParams.md)
- [getParamsFromURL](functions/getParamsFromURL.md)
- [getSearchParams](functions/getSearchParams.md)
- [getUrlFromString](functions/getUrlFromString.md)
